...
class MiniorangeOAuthClientSupport {
    ...
    public function sendSupportQuery()
    {
        if ($this->plan == 'demo') {
            ...
            $subject = "Demo request for Drupal-7 OAuth Module";
            ...
            $content = '<div >Hello, <br><br>Company :<a href="' . $_SERVER['SERVER_NAME'] . '" target="_blank" >' . $_SERVER['SERVER_NAME'] . '</a><br><br>Phone Number:' . $this->phone . '<br><br>Email:<a href="mailto:' . $this->email . '" target="_blank">' . $this->email . '</a><br><br>Query:[DRUPAL 7 OAuth Client Free] ' . $this->query . '</div>';
            ...
            $this->query = '[Drupal 7 OAuth Client - Free] ' . $this->query;
            $fields = array(
