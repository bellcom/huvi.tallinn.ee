  ...
  <?php if (isset($filters) && !empty($filters)) :?>
    ...
    <?php foreach ($filters as $type => $filters) { ?>
      ...
      <div class="subevents-filter-input">
        <input type="text"  name="<?php print $type ?>" readonly="readonly" class="subevents-filter-textbox" value="<?php print $filters['label']?>"/>
      ...
      <div  class="subevents-filter-list">
        ...
        <div id="<?php print $key?>">
          <input class="regular-radio filter-radio" type="radio" <?php in_array($key, $active_filters[$type]) ? print 'checked' : '' ?> name="<?php print $type?>" value = "<?php print $key?>" > <?php print $label ?> </div>
          <?php if ($key == 'period') :?>
        ...
        <?php endif;?>
            <?php else: ?>
        <div>   <input class="regular-checkbox filter-checkbox" type="checkbox" <?php (in_array($key, $active_filters[$type]) || !isset($active_filters[$type])) ? print 'checked' : ''?> name="<?php print type ?>" value = "<?php print $key?>" id="<?php print $key?>"><?php print $label ?> </div>
        <?php endif ?>
